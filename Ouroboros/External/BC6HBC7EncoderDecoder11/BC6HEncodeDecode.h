...
public:
    ...
    //--------------------------------------------------------------------------------------
    HRESULT GPU_BC6HDecodeAndSave( ID3D11Texture2D* pSourceTexture, WCHAR* strDstFilename, ID3D11Texture2D** ppOutCompressedTexture ); // @oooii-tony: Add an output texture (rather than saving a file) );
    HRESULT GPU_BC6HDecodeAndSaveInternal( ID3D11Buffer* pSrcTextureAsBuf, UINT uWidth, UINT uHeight, DXGI_FORMAT fmtSrc, WCHAR* strDstFilename, ID3D11Texture2D** ppOutCompressedTexture ); // @oooii-tony: Add an output texture (rather than saving a file)
